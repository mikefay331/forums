            ...
            <div className="flex items-start gap-6 -mt-12">
              ...
              <div className="flex-1 pt-4">
                ...
                <div className="grid grid-cols-3 gap-4 mt-4">
                  ...
                  <div className="bg-[#2a2a2a] rounded p-3 text-center">
                    <p className="text-white text-2xl font-bold">{profile.total_rewards || 0}</p>
                    <p className="text-gray-500 text-xs">$FORUMS</p>
                  </div>
                </div>
                  ...
                  <div className="mt-4 space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-500 text-xs mt-1">
                        Your wallet address is used for $FORUMS token distributions
                      </p>
                    </div>
                    ...
                    {isOwnProfile && ! profile.wallet_address && (
                      <div className="bg-yellow-900/20 border border-yellow-600/30 rounded p-3">
                        <p className="text-yellow-400 text-sm">
                          ⚠️ Add your wallet address to receive $FORUMS token payouts!
                        </p>
                      </div>
                    )}
                  </div>
